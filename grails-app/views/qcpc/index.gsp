	...
	<aside class="main-sidebar">
		...
		<section class="sidebar">
			...
			<ul class="sidebar-menu">
				...
				<li>
					<a href="qcpc/create">
						<i class="fa fa-th"></i> <span>Create QCPC</span> <small class="label pull-right bg-green">new</small>
					</a>
				</li>
				<li>
					<a href="#">
						...
						<div class="box-body">
							<table id="example1" class="table table-bordered table-striped">
								...
								<tr>
									...
									<g:sortableColumn property="subject" title="${message(code: 'qcpc.subject.label', default: 'Subject')}" />

									<g:sortableColumn property="problemCategory" title="${message(code: 'qcpc.problemCategory.label', default: 'Problem Category')}" />

									<g:sortableColumn property="otherCategory" title="${message(code: 'qcpc.otherCategory.label', default: 'Other Category')}" />
			...
			<thead>
				...
				<g:each in="${qcpcInstanceList}" status="i" var="qcpcInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${qcpcInstance.id}">${fieldValue(bean: qcpcInstance, field: "subject")}</g:link></td>
					
						<td>${fieldValue(bean: qcpcInstance, field: "problemCategory")}</td>
					
						<td>${fieldValue(bean: qcpcInstance, field: "otherCategory")}</td>
