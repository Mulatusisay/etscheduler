            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li><a href="#trainingTimeline"><i class="fa fa-circle-o"></i> Timeline</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
                        ...
                        <div class="box-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <g:sortableColumn property="courseId"
                                                      title="${message(code: 'training.courseId.label', default: 'Cource Id')}"/>

                                    <g:sortableColumn property="courseName"
                                                      title="${message(code: 'training.courseName.label', default: 'Course Name')}"/>

                                    <g:sortableColumn property="description"
                                                      title="${message(code: 'training.description.label', default: 'Description')}"/>

                                    <g:sortableColumn property="courceDurationInHours"
                                                      title="${message(code: 'training.courceDurationInHours.label', default: 'Cource Duration In Hours')}"/>

                                    <g:sortableColumn property="category"
                                                      title="${message(code: 'training.category.label', default: 'Category')}"/>

                                    <g:sortableColumn property="refresherDurationInMonths"
                                                      title="${message(code: 'training.refresherDurationInMonths.label', default: 'Refresher Duration In Months')}"/>

                                    <g:sortableColumn property="trainingConducted"
                                                      title="${message(code: 'training.trainingConducted.label', default: 'Training Conducted')}"/>

                                    <g:sortableColumn property="prerequisite"
                                                      title="${message(code: 'training.prerequisite.label', default: 'Prerequisite')}"/>
                                ...
                                <g:each in="${trainingInstanceList}" status="i" var="trainingInstance">
                                    <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                                        ...
                                        <td><g:link action="show"
                                                    id="${trainingInstance.id}">${fieldValue(bean: trainingInstance, field: "courseId")}</g:link></td>

                                        <td>${fieldValue(bean: trainingInstance, field: "courseName")}</td>

                                        <td>${fieldValue(bean: trainingInstance, field: "description")}</td>

                                        <td>${fieldValue(bean: trainingInstance, field: "courseDurationInHours")}</td>

                                        <td>${fieldValue(bean: trainingInstance, field: "category")}</td>

                                        <td>${fieldValue(bean: trainingInstance, field: "refresherDurationInMonths")}</td>

                                        <td>${fieldValue(bean: trainingInstance, field: "trainingConducted")}</td>

                                        <td>${fieldValue(bean: trainingInstance, field: "prerequisite")}</td>
