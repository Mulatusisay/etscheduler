...
<div id="show-schedule" class="content scaffold-show" role="main">
    ...
    <ol class="property-list schedule">
        ...
        <g:if test="${scheduleInstance?.trainingRecord}">
            <li class="fieldcontain">
                <span id="trainingRecord-label" class="property-label"><g:message code="schedule.trainingRecord.label"
                                                                                  default="Training Record"/></span>

                <g:each in="${scheduleInstance.trainingRecord}" var="t">
