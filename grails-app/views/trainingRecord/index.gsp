...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'trainingRecord.label', default: 'Training Record')}" />
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li>
                                        <a href="#">
                                            <i class="fa fa-users text-aqua"></i> new course
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="#">
                        <i class="fa fa-book"></i> <span>Trainig</span>
                        <i class="fa fa-angle-left pull-right"></i>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="training/create"><i class="fa fa-circle-o"></i> Create Course</a></li>
