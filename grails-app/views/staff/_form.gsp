...
<div class="fieldcontain ${hasErrors(bean: staffInstance, field: 'trainingRecord', 'error')} ">
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="trainingRecord" action="create"
                    params="['staff.id': staffInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'trainingRecord.label', default: 'TrainingRecord')])}</g:link>
        </li>
    </ul>
...
<div class="fieldcontain ${hasErrors(bean: staffInstance, field: 'workDetail', 'error')} ">
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="workDetail" action="create"
                    params="['staff.id': staffInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'workDetail.label', default: 'WorkDetail')])}</g:link>
        </li>
    </ul>
...
<div class="fieldcontain ${hasErrors(bean: staffInstance, field: 'employeeDetail', 'error')} ">
    ...
    <ul class="one-to-many">
        ...
        <li class="add">
            <g:link controller="employeeDetail" action="create"
                    params="['staff.id': staffInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'employeeDetail.label', default: 'EmployeeDetail')])}</g:link>
        </li>
    </ul>
