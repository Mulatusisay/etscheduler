...
<div id="show-staff" class="content scaffold-show" role="main">
    ...
    <ol class="property-list staff">
        ...
        <g:if test="${staffInstance?.middleName}">
            <li class="fieldcontain">
                <span id="middleName-label" class="property-label"><g:message code="staff.middleName.label"
                                                                              default="Middle Name"/></span>

                <span class="property-value" aria-labelledby="middleName-label"><g:fieldValue bean="${staffInstance}"
        ...
        <g:if test="${staffInstance?.trainingRecord}">
            <li class="fieldcontain">
                <span id="trainingRecord-label" class="property-label"><g:message code="staff.trainingRecord.label"
                                                                                  default="Training Record"/></span>

                <g:each in="${staffInstance.trainingRecord}" var="t">
                    <span class="property-value" aria-labelledby="trainingRecord-label"><g:link
                            controller="trainingRecord" action="show" id="${t.id}">${t?.encodeAsHTML()}</g:link></span>
                </g:each>
        ...
        <g:if test="${staffInstance?.workDetail}">
            <li class="fieldcontain">
                <span id="workDetail-label" class="property-label"><g:message code="staff.workDetail.label"
                                                                              default="Work Detail"/></span>
        ...
        <g:if test="${staffInstance?.employeeDetail}">
            <li class="fieldcontain">
                <span id="employeeDetail-label" class="property-label"><g:message code="staff.employeeDetail.label"
                                                                                  default="Employee Detail"/></span>
    ...
    <g:form url="[resource: staffInstance, action: 'delete']" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${staffInstance}"><g:message code="edit"
                                                                                      default="Add Details"/></g:link>
